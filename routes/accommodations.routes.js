...
router.get('/:accommodationID/reservations', authController.verifyToken, authController.isFacilitatorOrAdmin, accommodationController.findRservationByAccommodation) //Verificação do facilitador
...
router.post('/:accommodationID/comments',authController.verifyToken, accommodationController.createComment)
